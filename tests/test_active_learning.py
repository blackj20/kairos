...
class ActiveLearningTests(unittest.TestCase):
    ...
    def test_active_session_survives_restart(self) -> None:
        with tempfile.TemporaryDirectory() as temp:
            ...
            restarted_kernel = Kernel(cognitive_repository=second)
            operational = restarted_kernel.traiter("installe")
            self.assertIsNotNone(operational.question_id)
            self.assertIn("cible", operational.reponse.casefold())
